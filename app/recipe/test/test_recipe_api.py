...
def image_upload_url(recipe_id):
    """Return URL for recipe imag upload"""
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name='Sing')
        tag2 = sample_tag(user=self.user, name='Wong')
        payload = {
            'title': 'test test',
            'time_minutes': 10,
            'price': 10.00,
    ...
    def test_create_recipe_with_ingredient(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Sing')
        ingredient2 = sample_ingredient(user=self.user, name='Wong')
        payload = {
            'title': 'test test',
            'time_minutes': 10,
            'price': 10.00,
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user,title='test 1q')
        recipe2 = sample_recipe(user=self.user,title='test 2q')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user,title='test 1q')
        recipe2 = sample_recipe(user=self.user,title='test 2q')
        ingredient1 = sample_ingredient(user=self.user, name='test ingredient1')
